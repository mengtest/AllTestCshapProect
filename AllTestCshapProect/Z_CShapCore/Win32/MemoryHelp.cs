...
namespace Z_CShapCore {
    //IntPtr byteAddress;
    //Console.WriteLine(MemoryHelp.ReadMemoryValue(0x33f700, "ConsoleApplication1", out byteAddress));
    //Console.WriteLine(Marshal.PtrToStringAnsi(byteAddress));
    //
    //Console.WriteLine(MemoryHelp.ReadMemoryValue(0x33f6f4, "ConsoleApplication1"));
    //MemoryHelp.WriteMemoryValue(0x33f6f4, "ConsoleApplication1",10086);


    //Console.WriteLine(MemoryHelp.ReadMemoryValue(0x33f6f4, "ConsoleApplication1"));
    //MemoryHelp.WriteMemoryValue(0x33f6f4, "ConsoleApplication1", 10086);

    //Console.WriteLine(0x1234 + 4);
    ...
    public class MemoryHelp {
        ...
        //读取内存的值  
        public static int ReadMemoryValue (int baseAddress , string ProcessName , out IntPtr ptr) {
            try {
                byte[] buffer = new byte[1024];
                IntPtr byteAddress = Marshal.UnsafeAddrOfPinnedArrayElement(buffer , 0);
                IntPtr hProcess = OpenProcess(0x1F0FFF , false , GetPidByProcessName(ProcessName));
                ReadProcessMemory(hProcess , (IntPtr)baseAddress , byteAddress , 1024 , IntPtr.Zero);
