...
./protoc --cpp_out=../../Src/proto/ GameProtocol.Rank.proto || exit 1
./protoc --cpp_out=../../Src/proto/ GameProtocol.Mail.proto || exit 1
./protoc --cpp_out=../../Src/proto/ GameProtocol.Center.proto || exit 1
...
mv ../../Src/proto/GameProtocol.Rank.pb.cc ../../Src/proto/GameProtocol.Rank.pb.cpp
mv ../../Src/proto/GameProtocol.Mail.pb.cc ../../Src/proto/GameProtocol.Mail.pb.cpp
mv ../../Src/proto/GameProtocol.Center.pb.cc ../../Src/proto/GameProtocol.Center.pb.cpp
